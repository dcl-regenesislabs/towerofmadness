...
// export function setupClaimingUi_deprecated() {
...
// let waitPromptUi: ui.CustomPrompt
// export function showWaitingUI(val: boolean){
//     if(!val) {
//         waitPromptUi.hide()
//         return
//     }

//     waitPromptUi = ui.createComponent(ui.CustomPrompt, {
//         style: ui.PromptStyles.DARK,
//         height: 150,
//     })  
//     const promptTitle = waitPromptUi.addText({
//         value: 'Preparing your wearable.\nPlease wait and do not leave the scene.',
//         xPosition: -120,
//         yPosition: 50,
//         size: 20,
//     })
...
//     utils.playSound('sounds/star-collect.mp3', false, Transform.get(engine.CameraEntity).position)
// }
  

// export function alreadyClaimedUI() {

//     const promptAlreadyClaimed = ui.createComponent(ui.CustomPrompt, {
//         style: ui.PromptStyles.DARK,
//         height: 200,
//     })

//     const promptTitle = promptAlreadyClaimed.addText({
...
//     const promptButtonE = promptAlreadyClaimed.addButton({
//         style: ui.ButtonStyles.E,
//         text: 'Ok',
//         xPosition: -20,
//         yPosition: -150,
//         onMouseDown: () => {
//           console.log('Yeah clicked')
//           promptAlreadyClaimed.hide()
//         },
//     })

//     promptAlreadyClaimed.show()
...
// let warningPrompt: ui.OkPrompt | undefined = undefined

// export function hideWarningPrompt(){
//     if(warningPrompt){
//         warningPrompt.hide()
//     }
// }

// export function warningUI(warningString: string, callback?: (() => void | undefined)) {
//     let cb = () => {
//         console.log('accepted')
//         if(warningPrompt) warningPrompt.hide()
//     }
//     if(callback){
//         cb = () => {
//             callback()
...
//     warningPrompt = ui.createComponent(ui.OkPrompt, {
//       text: warningString,
//       onAccept: cb,
//       acceptLabel: 'Ok',
//       useDarkTheme: true,
